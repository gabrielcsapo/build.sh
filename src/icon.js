...
class Icon extends Component {
  render () {
    ...
    switch (status) {
      case 'success':
        icon = <polygon points='-2.00 2.80 -4.80 0.00 -5.73 0.933 -2.00 4.67 6.00 -3.33 5.07 -4.27' />
        break
      case 'fail':
        icon = <polygon points='4.67 -3.73 3.73 -4.67 0 -0.94 -3.73 -4.67 -4.67 -3.73 -0.94 0 -4.67 3.73 -3.73 4.67 0 0.94 3.73 4.67 4.67 3.73 0.94 0' />
        break
      case 'unknown':
